...
class WebApiTest(unittest.TestCase):
    ...
    def test_static_workspace_uses_analysis_tabs_and_export_panel(self) -> None:
        ...
        self.assertIn('data-analysis-tab="polarization"', index_html)
        ...
        self.assertIn('id="fitParameterSummary"', index_html)
        ...
        self.assertIn('id="rmPhiStepInput"', index_html)
        self.assertIn('id="rmDownloadJsonButton"', index_html)
        self.assertIn('id="rmDownloadCsvButton"', index_html)
        self.assertIn('id="rmPlot"', index_html)
        self.assertIn('id="rmQuPlot"', index_html)
        ...
        self.assertIn("function importRmSpectrum", app_js)
        self.assertIn("function parseRmCsv", app_js)
        self.assertIn("function runRmSynthesis", app_js)
        self.assertIn("function renderRmSynthesis", app_js)
        self.assertIn("function downloadRmResultJson", app_js)
        self.assertIn("function downloadRmSpectrumCsv", app_js)
        self.assertIn('fetch("/api/rm-synthesis"', app_js)
  ...
  updateControlStates()
        ...
        self.assertIn("DM Fit Width", app_js)
        self.assertIn("function dmFitWidthDisplayDetail(detail)", app_js)
        self.assertIn('dm_fit_width: "Fit width"', app_js)
        self.assertIn("diagnostic local-fit width", app_js)
        self.assertNotIn("publishable 1-sigma DM error bar", app_js)
        self.assertNotIn("formal 1-sigma uncertainty", app_js)
